package com.zcz.web.core.constant;
...
public class Const {
	...
	/**
	 * ServletContext中,保存在线用户Session信息 parm:'sessions' value:HashMap
	 * <String,HttpSession>{Map中key:userId} session parm:userId value:principals
	 */
